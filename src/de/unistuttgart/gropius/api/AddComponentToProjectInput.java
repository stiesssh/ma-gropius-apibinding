...
public class AddComponentToProjectInput implements Serializable {
    ...
    public AddComponentToProjectInput(ID projectId, ID componentId) {
    ...
    public AddComponentToProjectInput setProjectId(ID projectId) {
        this.projectId = projectId;
        return this;
    }
    ...
    public AddComponentToProjectInput setComponentId(ID componentId) {
        this.componentId = componentId;
        return this;
    }
    ...
    public AddComponentToProjectInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public AddComponentToProjectInput setClientMutationIdInput(Input<String> clientMutationId) {
