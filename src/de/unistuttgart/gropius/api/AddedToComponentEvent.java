...
*/
public class AddedToComponentEvent extends AbstractResponse<AddedToComponentEvent> implements IssueTimelineItem, Node {
    public AddedToComponentEvent() {
    }

    public AddedToComponentEvent(JsonObject fields) throws SchemaViolationError {
    ...
    public AddedToComponentEvent(ID id) {
        this();
        optimisticData.put("id", id);
    }

    public String getGraphQlTypeName() {
        return "AddedToComponentEvent";
    }
    ...
    */
    ...
    public AddedToComponentEvent setIssue(Issue arg) {
    ...
    */
    ...
    public AddedToComponentEvent setCreatedBy(User arg) {
    ...
    */
    ...
    public AddedToComponentEvent setCreatedAt(Date arg) {
    ...
    */
    ...
    public AddedToComponentEvent setComponent(Component arg) {
