...
*/
public class RemovedFromComponentEvent extends AbstractResponse<RemovedFromComponentEvent> implements IssueTimelineItem, Node {
    public RemovedFromComponentEvent() {
    }

    public RemovedFromComponentEvent(JsonObject fields) throws SchemaViolationError {
    ...
    public RemovedFromComponentEvent(ID id) {
        this();
        optimisticData.put("id", id);
    }

    public String getGraphQlTypeName() {
        return "RemovedFromComponentEvent";
    }
    ...
    */
    ...
    public RemovedFromComponentEvent setIssue(Issue arg) {
    ...
    */
    ...
    public RemovedFromComponentEvent setCreatedBy(User arg) {
    ...
    */
    ...
    public RemovedFromComponentEvent setCreatedAt(Date arg) {
    ...
    */
    ...
    public Component getRemovedComponent() {
        return (Component) get("removedComponent");
    }

    public RemovedFromComponentEvent setRemovedComponent(Component arg) {
        optimisticData.put(getKey("removedComponent"), arg);
        return this;
    }
    ...
    public boolean unwrapsToObject(String key) {
        switch (getFieldName(key)) {
            ...
            case "removedComponent": return true;
