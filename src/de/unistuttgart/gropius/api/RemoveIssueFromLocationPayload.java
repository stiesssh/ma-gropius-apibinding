...
public class RemoveIssueFromLocationPayload extends AbstractResponse<RemoveIssueFromLocationPayload> {
    ...
    public RemoveIssueFromLocationPayload(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                ...
                case "event": {
                    RemovedFromLocationEvent optional1 = null;
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new RemovedFromLocationEvent(jsonAsObject(field.getValue(), key));
                    }
    ...
    */
    ...
    public RemoveIssueFromLocationPayload setLocation(IssueLocation arg) {
    ...
    */
    ...
    public RemovedFromLocationEvent getEvent() {
        return (RemovedFromLocationEvent) get("event");
    }

    public RemoveIssueFromLocationPayload setEvent(RemovedFromLocationEvent arg) {
