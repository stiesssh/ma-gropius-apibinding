...
public class AddIssueToLocationPayloadQuery extends Query<AddIssueToLocationPayloadQuery> {
    ...
    */
    public AddIssueToLocationPayloadQuery location(IssueLocationQueryDefinition queryDef) {
        startField("location");
    ...
    */
    public AddIssueToLocationPayloadQuery event(AddedToLocationEventQueryDefinition queryDef) {
        startField("event");
