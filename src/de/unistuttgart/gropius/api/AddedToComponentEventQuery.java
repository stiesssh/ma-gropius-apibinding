...
*/
public class AddedToComponentEventQuery extends Query<AddedToComponentEventQuery> {
    AddedToComponentEventQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public AddedToComponentEventQuery issue(IssueQueryDefinition queryDef) {
        startField("issue");
    ...
    */
    public AddedToComponentEventQuery createdBy(UserQueryDefinition queryDef) {
    ...
    */
    public AddedToComponentEventQuery createdAt() {
    ...
    */
    public AddedToComponentEventQuery component(ComponentQueryDefinition queryDef) {
