...
public class DeleteProjectInput implements Serializable {
    private ID projectId;

    private Input<String> clientMutationId = Input.undefined();

    public DeleteProjectInput(ID projectId) {
    ...
    public DeleteProjectInput setProjectId(ID projectId) {
        this.projectId = projectId;
        return this;
    }
    ...
    public DeleteProjectInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public DeleteProjectInput setClientMutationIdInput(Input<String> clientMutationId) {
