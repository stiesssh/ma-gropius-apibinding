...
public class RemoveIssueFromComponentInput implements Serializable {
    private ID issue;
    ...
    public RemoveIssueFromComponentInput(ID issue, ID component) {
        this.issue = issue;
    ...
    public RemoveIssueFromComponentInput setIssue(ID issue) {
        this.issue = issue;
        return this;
    }
    ...
    public RemoveIssueFromComponentInput setComponent(ID component) {
        this.component = component;
        return this;
    }
    ...
    public RemoveIssueFromComponentInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public RemoveIssueFromComponentInput setClientMutationIdInput(Input<String> clientMutationId) {
