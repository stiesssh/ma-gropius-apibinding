...
public class AddIssueToComponentInput implements Serializable {
    private ID issue;
    ...
    public AddIssueToComponentInput(ID issue, ID component) {
        this.issue = issue;
    ...
    public AddIssueToComponentInput setIssue(ID issue) {
        this.issue = issue;
        return this;
    }
    ...
    public AddIssueToComponentInput setComponent(ID component) {
        this.component = component;
        return this;
    }
    ...
    public AddIssueToComponentInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public AddIssueToComponentInput setClientMutationIdInput(Input<String> clientMutationId) {
