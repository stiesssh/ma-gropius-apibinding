...
*/
public class AddLabelToIssuePayload extends AbstractResponse<AddLabelToIssuePayload> {
    public AddLabelToIssuePayload() {
    }

    public AddLabelToIssuePayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddLabelToIssuePayload setClientMutationId(String arg) {
    ...
    */
    ...
    public AddLabelToIssuePayload setLabel(Label arg) {
    ...
    */
    ...
    public AddLabelToIssuePayload setIssue(Issue arg) {
    ...
    */
    ...
    public AddLabelToIssuePayload setEvent(LabelledEvent arg) {
    ...
    */
    ...
    public AddLabelToIssuePayload setTimelineEdge(IssueTimelineItemEdge arg) {
