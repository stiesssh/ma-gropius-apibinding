...
public class RemoveLabelFromIssueInput implements Serializable {
    private ID issue;
    ...
    public RemoveLabelFromIssueInput(ID issue, ID label) {
        this.issue = issue;
    ...
    public RemoveLabelFromIssueInput setIssue(ID issue) {
        this.issue = issue;
        return this;
    }
    ...
    public RemoveLabelFromIssueInput setLabel(ID label) {
        this.label = label;
        return this;
    }
    ...
    public RemoveLabelFromIssueInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public RemoveLabelFromIssueInput setClientMutationIdInput(Input<String> clientMutationId) {
