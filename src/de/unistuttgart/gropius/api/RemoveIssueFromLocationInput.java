...
public class RemoveIssueFromLocationInput implements Serializable {
    ...
    public RemoveIssueFromLocationInput(ID issue, ID location) {
        this.issue = issue;
    ...
    public RemoveIssueFromLocationInput setLocation(ID location) {
        this.location = location;
        return this;
    }
    ...
    public void appendTo(StringBuilder _queryBuilder) {
        ...
        Query.appendQuotedString(_queryBuilder, location.toString());
