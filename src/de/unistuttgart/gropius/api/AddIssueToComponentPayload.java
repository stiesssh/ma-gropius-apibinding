...
*/
public class AddIssueToComponentPayload extends AbstractResponse<AddIssueToComponentPayload> {
    public AddIssueToComponentPayload() {
    }

    public AddIssueToComponentPayload(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                ...
                case "event": {
                    AddedToComponentEvent optional1 = null;
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new AddedToComponentEvent(jsonAsObject(field.getValue(), key));
                    }
    ...
    public String getGraphQlTypeName() {
        return "AddIssueToComponentPayload";
    }
    ...
    */
    ...
    public AddIssueToComponentPayload setClientMutationId(String arg) {
    ...
    */
    ...
    public AddIssueToComponentPayload setComponent(Component arg) {
    ...
    */
    ...
    public AddIssueToComponentPayload setIssue(Issue arg) {
    ...
    */
    ...
    public AddedToComponentEvent getEvent() {
        return (AddedToComponentEvent) get("event");
    }

    public AddIssueToComponentPayload setEvent(AddedToComponentEvent arg) {
    ...
    */
    ...
    public AddIssueToComponentPayload setTimelineEdge(IssueTimelineItemEdge arg) {
