...
*/
public class RemovedFromLocationEventQuery extends Query<RemovedFromLocationEventQuery> {
    RemovedFromLocationEventQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public RemovedFromLocationEventQuery issue(IssueQueryDefinition queryDef) {
        startField("issue");
    ...
    */
    public RemovedFromLocationEventQuery createdBy(UserQueryDefinition queryDef) {
    ...
    */
    public RemovedFromLocationEventQuery createdAt() {
    ...
    */
    public RemovedFromLocationEventQuery removedLocation(IssueLocationQueryDefinition queryDef) {
