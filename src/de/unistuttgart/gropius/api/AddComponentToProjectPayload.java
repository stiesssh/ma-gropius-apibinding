...
*/
public class AddComponentToProjectPayload extends AbstractResponse<AddComponentToProjectPayload> {
    public AddComponentToProjectPayload() {
    }

    public AddComponentToProjectPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddComponentToProjectPayload";
    }
    ...
    */
    ...
    public AddComponentToProjectPayload setClientMutationId(String arg) {
    ...
    */
    ...
    public AddComponentToProjectPayload setProject(Project arg) {
    ...
    */
    ...
    public AddComponentToProjectPayload setComponent(Component arg) {
