...
*/
public class RemoveLabelFromIssuePayload extends AbstractResponse<RemoveLabelFromIssuePayload> {
    public RemoveLabelFromIssuePayload() {
    }

    public RemoveLabelFromIssuePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "RemoveLabelFromIssuePayload";
    }
    ...
    */
    ...
    public RemoveLabelFromIssuePayload setClientMutationId(String arg) {
    ...
    */
    ...
    public RemoveLabelFromIssuePayload setLabel(Label arg) {
    ...
    */
    ...
    public RemoveLabelFromIssuePayload setIssue(Issue arg) {
    ...
    */
    ...
    public RemoveLabelFromIssuePayload setEvent(UnlabelledEvent arg) {
    ...
    */
    ...
    public RemoveLabelFromIssuePayload setTimelineEdge(IssueTimelineItemEdge arg) {
