...
*/
public class CreateProjectPayload extends AbstractResponse<CreateProjectPayload> {
    public CreateProjectPayload() {
    }

    public CreateProjectPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CreateProjectPayload setClientMutationId(String arg) {
    ...
    */
    ...
    public CreateProjectPayload setProject(Project arg) {
