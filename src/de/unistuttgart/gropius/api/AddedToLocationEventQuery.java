...
*/
public class AddedToLocationEventQuery extends Query<AddedToLocationEventQuery> {
    AddedToLocationEventQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    ...
    */
    public AddedToLocationEventQuery issue(IssueQueryDefinition queryDef) {
        startField("issue");
    ...
    */
    public AddedToLocationEventQuery createdBy(UserQueryDefinition queryDef) {
    ...
    */
    public AddedToLocationEventQuery createdAt() {
    ...
    */
    public AddedToLocationEventQuery location(IssueLocationQueryDefinition queryDef) {
        startField("location");
