...
public class UnlinkIssuePayload extends AbstractResponse<UnlinkIssuePayload> {
    ...
    public UnlinkIssuePayload(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                ...
                case "event": {
                    UnlinkEvent optional1 = null;
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new UnlinkEvent(jsonAsObject(field.getValue(), key));
                    }
    ...
    */
    ...
    public UnlinkIssuePayload setIssue(Issue arg) {
    ...
    */
    ...
    public UnlinkEvent getEvent() {
        return (UnlinkEvent) get("event");
    }

    public UnlinkIssuePayload setEvent(UnlinkEvent arg) {
