...
public class DeleteIssueCommentPayloadQuery extends Query<DeleteIssueCommentPayloadQuery> {
    ...
    */
    public DeleteIssueCommentPayloadQuery issue(IssueQueryDefinition queryDef) {
        startField("issue");
    ...
    */
    public DeleteIssueCommentPayloadQuery event(DeletedIssueCommentQueryDefinition queryDef) {
        startField("event");
