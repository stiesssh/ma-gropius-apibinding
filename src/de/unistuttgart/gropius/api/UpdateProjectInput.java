...
public class UpdateProjectInput implements Serializable {
    ...
    public UpdateProjectInput(ID projectId) {
    ...
    public UpdateProjectInput setProjectId(ID projectId) {
        this.projectId = projectId;
        return this;
    }
    ...
    public UpdateProjectInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public UpdateProjectInput setClientMutationIdInput(Input<String> clientMutationId) {
    ...
    public UpdateProjectInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public UpdateProjectInput setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public UpdateProjectInput setDescription(String description) {
        this.description = Input.optional(description);
        return this;
    }

    public UpdateProjectInput setDescriptionInput(Input<String> description) {
        if (description == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
