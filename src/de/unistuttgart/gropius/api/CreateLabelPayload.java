...
*/
public class CreateLabelPayload extends AbstractResponse<CreateLabelPayload> {
    public CreateLabelPayload() {
    }

    public CreateLabelPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public CreateLabelPayload setClientMutationId(String arg) {
    ...
    */
    ...
    public CreateLabelPayload setLabel(Label arg) {
