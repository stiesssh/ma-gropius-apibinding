...
public class AddIssueToLocationPayload extends AbstractResponse<AddIssueToLocationPayload> {
    ...
    public AddIssueToLocationPayload(JsonObject fields) throws SchemaViolationError {
        for (Map.Entry<String, JsonElement> field : fields.entrySet()) {
            ...
            switch (fieldName) {
                ...
                case "event": {
                    AddedToLocationEvent optional1 = null;
                    if (!field.getValue().isJsonNull()) {
                        optional1 = new AddedToLocationEvent(jsonAsObject(field.getValue(), key));
                    }
    ...
    */
    ...
    public AddIssueToLocationPayload setLocation(IssueLocation arg) {
    ...
    */
    ...
    public AddedToLocationEvent getEvent() {
        return (AddedToLocationEvent) get("event");
    }

    public AddIssueToLocationPayload setEvent(AddedToLocationEvent arg) {
