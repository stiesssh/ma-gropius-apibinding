...
public class TestMutationInput implements Serializable {
    ...
    public TestMutationInput setClientMutationId(String clientMutationId) {
        this.clientMutationId = Input.optional(clientMutationId);
        return this;
    }

    public TestMutationInput setClientMutationIdInput(Input<String> clientMutationId) {
